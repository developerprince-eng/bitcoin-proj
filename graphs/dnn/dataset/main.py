...
class DATASET():
    ...
    def __obtain_data__csv__el__lbencode__(self, path, number_features, number_labels, test_size=None, random_state=None):
        if (test_size is not None and random_state is not None):
            ...
            temp_x16 = label_encoder.fit_transform(ref_input_x.iloc[ : , 15:16])
            temp_x17 = label_encoder.fit_transform(ref_input_x.iloc[ : , 16:17])
            temp_x18 = label_encoder.fit_transform(ref_input_x.iloc[ : , 17:18])
            temp_x19 = label_encoder.fit_transform(ref_input_x.iloc[ : , 18:19])
            temp_x20 = label_encoder.fit_transform(ref_input_x.iloc[ : , 19:20])
            temp_x21 = label_encoder.fit_transform(ref_input_x.iloc[ : , 20:21])
            temp_x22 = label_encoder.fit_transform(ref_input_x.iloc[ : , 21:22])
            temp_x23 = label_encoder.fit_transform(ref_input_x.iloc[ : , 22:23])
            temp_x24 = label_encoder.fit_transform(ref_input_x.iloc[ : , 23:24])
            temp_x25 = label_encoder.fit_transform(ref_input_x.iloc[ : , 24:25])
            temp_x26 = label_encoder.fit_transform(ref_input_x.iloc[ : , 25:26])
            temp_x27 = label_encoder.fit_transform(ref_input_x.iloc[ : , 26:27])
            temp_x28 = label_encoder.fit_transform(ref_input_x.iloc[ : , 27:28])

            temp_x = pd.DataFrame({'x1':temp_x1, 'x2':temp_x2, 'x3':temp_x3, 'x4':temp_x4, 'x5':temp_x5, 'x6':temp_x6, 'x7':temp_x7, 'x8':temp_x8, 'x9':temp_x9, 'x10':temp_x10, 'x11':temp_x11, 'x12':temp_x12, 'x13':temp_x13, 'x14':temp_x14, 'x15':temp_x15, 'x16': temp_x16, 'x17':temp_x17, 'x18':temp_x18, 'x19':temp_x19, 'x20':temp_x20, 'x21':temp_x21, 'x22':temp_x22, 'x23':temp_x23, 'x24':temp_x24, 'x25':temp_x25, 'x26':temp_x26, 'x27':temp_x27, 'x28':temp_x28})
